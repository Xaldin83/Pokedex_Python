...
list_capacity = [Bluff,Rugissement, Ruse, Griffe, Jackpot, Morsure, Provoc, Assurance, Combo_Griffe,Grincement,Tranche,Machination, Calinerie]
Pokemon = Classe_Pokemon.Pokemon("Miaouss",52,[40, 45, 35, 40, 40, 90],list_capacity,"./Pokémon_img/G1/Miaouss.png","Normal","None","Ramassage","Technicien","Tension",0.4,4.2)
