...
liste_attaque = [Charge,Rugissement, TranchHerbe, Poudre_Toxik,Synthese,Protection, Feuille_Magik,Vampigraine, Doux_Parfum, Mur_Lumiere,Plaquage,Rune_Protect,Giga_Sangsue,Lance_Soleil,Mimi_Queue,Feuillage,Voix_Enjoleuse,Tempete_Verte]
Pokemon = Classe_Pokemon.Pokemon("Germignon",152,[45, 49, 65, 49, 65, 45],liste_attaque,"./Pokémon_img/G2/Germignon.png","Plante","None","Engrais","Feuille Garde","None",0.9,6.4)
